...
const PrivacyPage = () => {
    return (
        <main className="legal-page">
            ...
            <p>
                El responsable del tratamiento de los datos personales tratados
                a través de Scoundrel's Quest es:
            </p>
            ...
            <p>
                ...
                tratamiento de datos personales, puedes utilizar la dirección
            ...
            <p>
                ...
                determinados elementos de su perfil mediante imágenes o GIFs,
                incluyendo avatares y banners.
            </p>

            <p>
                Estos archivos se almacenan y muestran como parte de la
                funcionalidad de personalización del perfil.
            </p>

            <p>
                El usuario es responsable de los contenidos que decida subir y
                no debe utilizar imágenes o archivos que infrinjan derechos de
            ...
            <p>
                El servicio de correo puede tratar la información necesaria
                para entregar y gestionar los mensajes, como las direcciones
                de correo del remitente y destinatario y los datos técnicos
            ...
            <p>
                ...
                administración, supervisión y análisis técnico de la presencia
                del sitio en los resultados de búsqueda.
            </p>

            <p>
                Esta herramienta no se utiliza como sistema de publicidad ni
            ...
            <p>
                ...
                mecanismos de hash y el servicio utiliza conexiones cifradas
                mediante HTTPS cuando corresponde.
            </p>
            ...
            <p>
                ...
                incumple la normativa aplicable, puedes presentar una
            ...
            <p>
                ...
                mediante Ko-fi desde la sección de créditos.
            </p>

            <p>
                La realización de una donación es opcional y no es necesaria
